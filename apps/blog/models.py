...
class Author(models.Model):
    ...
    ''' Modificacion del titulo Canales Autor '''
    class Meta:                
      verbose_name_plural = "Canales Autor"
...
class ChannelTag(object):
	...
	''' Modificacion del titulo Canales Tag '''
	class Meta:                
		verbose_name_plural = "Canales Tag"
...
class Post(models.Model):
    ...
    mediaBlog = models.ManyToManyField(MediaPost)
